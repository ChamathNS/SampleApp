...
public class SampleAttributeRequestor implements AttributesRequestor {
    ...
    public boolean isRequired(String s, String s1) {

        return requiredMap.get(s1);
    }

    public String getTypeURI(String s, String s1) {

        return typeURIMap.get(s1);
    }

    public int getCount(String s, String s1) {

        return countMap.get(s1);
    }
}
